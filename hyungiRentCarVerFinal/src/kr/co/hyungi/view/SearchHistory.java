...
public class SearchHistory extends CommonMethod {
	...
	public void historyView(ArrayList<UsageHistoryBean> arUhb) {
		...
		for (int i = 0; i < arUhb.size(); i++) {
			...
			System.out.println("┃ [ 반납 날짜 ] : " + arUhb.get(i).getRentEndDate());
	...
	public void pageHistoryView(ArrayList<UsageHistoryBean> arUhb) {
		System.out.println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
		System.out.println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
		System.out.println("■■     조회된 대여 정보 결과         ■■");
		System.out.println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
		...
		for (int i = 0; i < arUhb.size(); i++) {
			...
			String input = "a";
			if(i==2) {
				System.out.println(" 다음: > enter시 조회 종료");
				input=inputMsg();
			}else if(i==arUhb.size()-1){
				System.out.println(" < :이전 enter시 조회 종료");
				input=inputMsg();
			}else if(i%3==2 && i!=arUhb.size()) {
				System.out.println(" < :이전  다음: > enter시 조회 종료");
				input=inputMsg();
			}
			if(input.equals("<")&&i==2) {
				...
				i-=6;
			}else if(input.equals(">")&&i==arUhb.size()-1) {
				System.out.println("잘못된 입력입니다");
				i-=3;
			}else if(input.equals(">")) {
	...
	public void historyView(UsageHistoryBean ub) {
		...
		System.out.println("┃ [ 반납 날짜 ] : " +ub.getRentEndDate());
