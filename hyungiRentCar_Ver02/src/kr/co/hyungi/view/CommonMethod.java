...
public class CommonMethod {
	...
	public String dateInputInput() {
		...
		System.out.println("**       					                                           	                       **");
		System.out.println("**       					          	                                                       **");
		System.out.println("**       		                   	±â°£À» ÀÔ·ÂÇÏ¼¼¿ä ex) 010102-010103 ´ë¿©½ÃÀÛÀÏ ±âÁØ                                                    **");
		System.out.println("**       					          	                                                       **");
		System.out.println("**       					           	                                                       **");
		System.out.println("**       					           	                                                       **");
		System.out.println("*************************************************************************************************************************");
		System.out.print("ÀÔ·Â:"); String dateInput = inputMsg();
	...
	public String carNoInput() {
		...
		System.out.println("**       					                                           	                       **");
		System.out.println("**       					          	                                                       **");
		System.out.println("**       		                   	Â÷·® ¹øÈ£¸¦ ÀÔ·ÂÇØÁÖ¼¼¿ä.                                                  **");
		System.out.println("**       					          	                                                       **");
		System.out.println("**       					           	                                                       **");
		System.out.println("**       					           	                                                       **");
		System.out.println("*************************************************************************************************************************");		
		System.out.print("ÀÔ·Â:"); String carNo = inputMsg();
	...
	public String licenseNoInput() {
		...
		System.out.println("**       					                                           	                       **");
		System.out.println("**       					          	                                                       **");
		System.out.println("**       		                   	¸éÇã¹øÈ£¸¦ ÀÔ·ÂÇÏ¼¼¿ä.	 	          	                           **");
		System.out.println("**       					          	                                                       **");
		System.out.println("**       					           	                                                       **");
		System.out.println("**       					           	                                                       **");
		System.out.println("*************************************************************************************************************************");
		System.out.print("ÀÔ·Â:");String licenseNo = inputMsg();
	...
	public String phoneNoInput() {
		...
		System.out.println("**       					                                           	                       **");
		System.out.println("**       					          	                                                       **");
		System.out.println("**       		                   	ÇÚµåÆù¹øÈ£¸¦ ÀÔ·ÂÇØÁÖ¼¼¿ä.	 	          	                       **");
		System.out.println("**       					          	                                                       **");
		System.out.println("**       					           	                                                       **");
		System.out.println("**       					           	                                                       **");
		System.out.println("*************************************************************************************************************************");
		System.out.print("ÀÔ·Â:"); String phoneNo = inputMsg();
	...
	public String contYesOrNoInput() {
		System.out.println("*************************************************************************************************************************");
		System.out.println("**       					                                           	                       **");
		System.out.println("**       					          	                                                       **");
		System.out.println("**       		                   	°Ô¼Ó ÀÔ·ÂÇÏ½Ã°Ú½À´Ï±î?(y,n)	 	          	                       **");
		System.out.println("**       					          	                                                       **");
		System.out.println("**       					           	                                                       **");
		System.out.println("**       					           	                                                       **");
		System.out.println("*************************************************************************************************************************");
		System.out.print("ÀÔ·Â:"); String yesOrNo = inputMsg();
